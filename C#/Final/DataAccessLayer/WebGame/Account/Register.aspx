<%@ Page Title="S'inscrire" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeBehind="Register.aspx.cs" Inherits="CowGame.Account.Register" %>
                ...
                <ContentTemplate>
                    ...
                    <div class="accountInfo">
                        <fieldset class="register">
                            ...
                            <p>
                                <asp:Label ID="NameLabel" runat="server" AssociatedControlID="Name">Nom :</asp:Label>
                                <asp:TextBox ID="Name" runat="server" CssClass="textEntry"></asp:TextBox>
                            </p>
                            <p>
                                <asp:Label ID="ActivityLabel" runat="server" AssociatedControlID="Activity">Rôle:</asp:Label>
                                <asp:DropDownList ID="Activity" runat="server">
                                    <asp:ListItem Value="Joueur" Selected="True">Joueur</asp:ListItem>
                                    <asp:ListItem Value="Editeur">Editeur</asp:ListItem>
                                </asp:DropDownList>
                            </p>
                            <p>
