...
public class Movies{
    ...
    private LinkedList<Language> languages_spoken;
    private String name;
    ...
    public LinkedList<Language> getLanguages_spoken() {
        return languages_spoken;
    }

    public void setLanguages_spoken(LinkedList<Language> languages_spoken) {
    ...
    public String[] getActeurs(){
        ...
        if(cast.size() > 0){      
            nomActeurs = new String[cast.size()];
            int cpt = 0;
            for(Cast personne : cast){
                if( personne.getJob().equals("Actor")){
                    nomActeurs[cpt] = quotes(personne.getName());
                    cpt++;
                }
            }
        }
    ...
    public String[] getDirecteurs(){
        String[] nomDirectors = null;
        if(cast.size() > 0){      
            nomDirectors = new String[cast.size()];
            int cpt = 0;
            
            for(Cast personne : cast){
                if( personne.getJob().equals("Director")){
                    nomDirectors[cpt] = personne.getName();
                    cpt++;
                }
            }
